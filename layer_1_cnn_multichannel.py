...
print "Loading Glove Wiki Model"
...
print "Loading Glove Twitter Model"
...
conv_1 = Conv3D(750, 2, d, 2, activation= 'relu')(inputs)
conv_2 = Conv3D(750, 3, d, 2, activation= 'relu')(inputs)
conv_3 = Conv3D(750, 4, d, 2, activation= 'relu')(inputs)
conv_4 = Conv3D(750, 5, d, 2, activation= 'relu')(inputs)
...
model.save('multi_channel_main_model_' + epochs +'.h5')
