...
files = open('/home/prudhvi/MLSP/glove.6B.300d.txt').read().splitlines()
...
max_pool_1 = MaxPooling2D(pool_size=(34, 1 ))(conv_1)
max_pool_2 = MaxPooling2D(pool_size=(33, 1 ))(conv_2)
max_pool_3 = MaxPooling2D(pool_size=(32, 1 ))(conv_3)
max_pool_4 = MaxPooling2D(pool_size=(31, 1))(conv_4)
...
model.save('glove_' + r + '_' + epochs +'_iter_model.h5')
